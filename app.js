...
const users = [ //TODO: DB
    ...
    {id: 2, name: 'Bob', email: 'bob@gmail.com', password: 'secret2'},
    {id: 3, name: 'Cat', email: 'cat@gmail.com', password: 'secret3'},
]
...
app.post('/register', redirectHome, (req, res) => {
    ...
    res.redirect('/register'); //TODO: qs errors for example /register?error=error.auth.userExists
})
